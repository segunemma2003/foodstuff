            ...
            <div class="dashboard_stats_wrap">
                <a asp-area="" asp-controller="Admin" asp-action="APActiveUsers">
                    ...
                    <div class="dashboard_stats_wrap_content">
                        <h4>
                            totalNumberOfActiveRegisteredUsers
                        </h4>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <a asp-area="" asp-controller="Admin" asp-action="APUnPaidInvoices">
                    ...
                    <div class="dashboard_stats_wrap_content">
                        <h4>
                            totalNumberOfPendingApprovalInvoices
                        </h4>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <a asp-area="" asp-controller="Admin" asp-action="APPaidInvoices">
                    ...
                    <div class="dashboard_stats_wrap_content">
                        <h4>
                            totalNumberOfDispatchedInvoices
                        </h4>
            ...
            <div class="dashboard_stats_wrap">
                <a asp-area="" asp-controller="Admin" asp-action="APUnreadQueries">
                    <div class="rounded-circle p-4 p-sm-4 d-inline-flex align-items-center justify-content-center bg-purple mb-2">
                        <div class="position-absolute text-white h5 mb-0"><i class="fas fa-question"></i></div>
                    </div>
                    <div class="dashboard_stats_wrap_content">
                        <h4>
                            unreadSupportQueries
                        </h4>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <a asp-area="" asp-controller="Admin" asp-action="APInvoices">
                    ...
                    <div class="dashboard_stats_wrap_content">
                        <h5>
                            ₦ BalanceFormatter(totalCompanyRevenue)
                        </h5>
            ...
            <div class="dashboard_stats_wrap">
                <a asp-area="" asp-controller="Admin" asp-action="APInvoices">
                    ...
                    <div class "dashboard_stats_wrap_content">
                        ...
                        <span>Total Company Orders</span>
                    </div>
                </a>
            </div>
        </div>
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <a asp-area="" asp-controller="Admin" asp-action="APInvoices">
                    ...
                    <div class="dashboard_stats_wrap_content">
                        <h5>₦ BalanceFormatter(totalCompanyRevenueIn7days)</h5>
                        <span>Income in 7days</span>
                    </div>
                </a>
            </div>
        </div>
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <a asp-area="" asp-controller="Admin" asp-action="APInvoices">
                    ...
                    <div class="dashboard_stats_wrap_content">
                        <h5>totalCompanyOrdersIn7Days</h5> <span>Orders in 7days</span>
                    </div>
                </a>
            </div>
        </div>
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap" style="height:300px;">
                <a href="#">
                    ...
                    <div class="dashboard_stats_wrap_content">
                        <span>Days customers visited the website the most</span>
                    </div>
                </a>
            </div>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap" style="height:300px;">
                <a href="#">
                    ...
                    <div class="dashboard_stats_wrap_content">
                        <span>Days customers visited the mobile app the most</span>
                    </div>
                </a>
            </div>
        </div>
...
<script>
    ...
    var yValues = [@.sunday0, @.monday0, @.tuesday0, @.wednesday0, @.thursday0, @.friday0, @.saturday0];
    ...
    var xValues = ["Sun", "Mon", "Tues", "Wed", "Thur", "Fri", "Sat"];
    var yValues = [@.sunday1, @.monday1, @.tuesday1, @.wednesday1, @.thursday1, @.friday1, @.saturday1];
    var barColors = ["red", "green", "blue", "orange", "brown", "purple", "yellow"];
