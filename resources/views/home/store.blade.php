    ...
    <div class="container">
                                    ...
                                    <div class="crs_grid_caption">
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="crs_fl_last">
                                                        <div class="crs_price">
                                                            <h4><span class="currency">₦</span><span class="theme-cl">@Data.Price</span></h4>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="preview_crs_info">
                                            ...
                                            @{
                                                ...
                                                {
                                                    <a href="#" data-toggle="modal" data-target="#login" class="btn btn-md full-width theme-bg text-white" style="text-align:center;">
                                                        <i class="fas fa-shopping-basket"></i>
                                                    </a>
                                                }
                                            }
                                                ...
                                                <div class="crs_grid_caption">
                                                    ...
                                                    <div class="crs_title">
                                                        <div class="property_block_wrap_header">
                                                            <ul class="nav nav-tabs customize-tab tabs_creative col-12" id="myTab" role="tablist">
                                                                <li class="nav-item">
                                                                    <a class="nav-link active" id="general-tab" data-toggle="tab" href="#general_@Data.ID" role="tab" aria-controls="general" aria-selected="true">Description</a>
                                                                </li>

                                                                <li class="nav-item">
                                                                    <a class="nav-link" id="payment-tab" data-toggle="tab" href="#payment_@Data.ID" role="tab" aria-controls="payment" aria-selected="false">More</a>
                                                                </li>

                                                                <li class="nav-item">
                                                                    <a class="nav-link" id="upgrade-tab" data-toggle="tab" href="#upgrade_@Data.ID" role="tab" aria-controls="upgrade" aria-selected="false">Reviews</a>
                                                                </li>
                                                    ...
                                                    <div class="crs_title">
                                                        <div class="tab-content tabs_content_creative" id="myTabContent">
                                                            ...
                                                            <!-- general Query -->
                                                            <div class="tab-pane fade show active" id="general_@Data.ID" role="tabpanel" aria-labelledby="general-tab">
                                                                <p><span>@Data.Description</span></p>
                                                            </div>

                                                            <!-- general Query -->
                                                            <div class="tab-pane fade" id="payment_@Data.ID" role="tabpanel" aria-labelledby="payment-tab">
                                                            ...
                                                            <!-- general Query -->
                                                            <div class="tab-pane fade" id="upgrade_@Data.ID" role="tabpanel" aria-labelledby="upgrade-tab">
        ...
        <div class="row align-items-center justify-content-between">
            ...
            @{
                ...
                else if (currentPage != 1 && foodStuffListItemsLength < 20)
                {
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <nav>
                            <ul class="pagination smalls m-0">
        ...
        <div class="row align-items-center justify-content-between mt-4">
            <div class="col-xl-12 col-lg-12 col-md-12">
                ...
                {
                    <button type="submit" style="color:#E10C2C; background-color:transparent; border:none;"><span> ← </span>Back To Home</button>
                }
            </div>
        </div>
    </div>
...
<div id="snackbar">
    <input id="alertSnackBar" type="text" style="text-align: center; background-color: transparent; border: none; color: white;" />
</div>
...
@*Like An Item Script*@
<script>function SubmitLikeForm(prodID) {
...
<script>int width = (Request.Browser.ScreenPixelsWidth) * 2 - 100;
    int height = (Request.Browser.ScreenPixelsHeight) * 2 - 100;</script>

@*Set data on description dialog*@
<script>function setDescription(img, name) {
        document.getElementById("descImage").src = img;
        document.getElementById('descNameLabel').innerHTML = name;
    }</script>

@*Navigate to next page*@
<script>function navToNextStorePage() {
