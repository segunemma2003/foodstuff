    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 pb-4">
                <div class="crs_partn">
                    <div class="p-3">
                        <img src="../../assets/img/JumiaFood.png" class="img-fluid" alt="Jumia Food Logo" title="Jumia Food" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="crs_partn">
                    <div class="p-3">
                        <img src="../../assets/img/BoltFood.png" class="img-fluid" alt="Bolt Food Logo" title="Bolt Food" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="crs_partn">
                    <div class="p-3">
                        <img src="../../assets/img/UberEats.png" class="img-fluid" alt="Uber Eats Logo" title="Uber Eats" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="crs_partn">
                    <div class="p-3">
                        <img src="../../assets/img/Heyfood.png" class="img-fluid" alt="Heyfood Logo" title="Heyfood" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="crs_partn">
                    <div class="p-3">
                        <img src="../../assets/img/Chowdeck.png" class="img-fluid" alt="Chowdeck Logo" title="Chowdeck" />
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-12 col-sm-12">
                <div class="call_action mt-4 mb-4 text-center">
                    ...
                    @if (ViewBag.doesUserOwnARestaurant)
                    {
                        <a asp-area="" asp-controller="Home" asp-action="OpenRestaurant" class="btn theme-bg text-white mt-2" target="_blank">
                            Manage Restaurants
                        </a>
                    }
                    else
