...
<!-- ============================ Page Title End ================================== -->
<!-- ============================ Download App ================================== -->
<section class="pb-0" style="background-image: url('../assets/img/Bg1.png');">
    <div class="container">

        <div class="row align-items-center justify-content-between rounded m-0">
            <div class="col-lg-12 col-md-12 pb-5">
                @using (Html.BeginForm("CreateStore", "Home", FormMethod.Post, new { id = "regForm", enctype = "multipart/form-data" }))
                {
                    ...
                    <div class="tab">
                        ...
                        <div class="form-group smalls">
                            ...
                            <div class="custom-file">
                                <select type="text" name="numberoflocations" class="form-control">
                                    <option>1</option>
                                    <option>2-5</option>
                                    <option>6-10</option>
                                    <option>11-25</option>
