    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                <div class="lmp_thumb">
                    <img src="~/assets/img/OurStory1.png" class="img-fluid" alt="" />
                </div>
                <br />
                <div class="lmp_thumb">
                    <img src="~/assets/img/OurStory2.png" class="img-fluid" alt="" />
                </div>
                <br />
                <div class="lmp_thumb">
                    <img src="~/assets/img/OurStory3.png" class="img-fluid" alt="" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="crs_partn">
                    <div class="p-3">
                        <img src="~/assets/img/PayStackLogo.png" class="img-fluid" alt="Paystack Brand Logo" title="PayStack" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="crs_partn">
                    <div class="p-3">
                        <img src="~/assets/img/FlutterwaveLogo.png" class="img-fluid" alt="Flutterwave Brand Logo" title="Flutterwave" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="crs_partn">
                    <div class="p-3">
                        <img src="~/assets/img/JedilabsLogo.png" class="img-fluid" alt="Jedi Labs Brand Logo" title="Jedi Labs" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="crs_partn">
                    <div class="p-3">
                        <img src="~/assets/img/IntersectConsortium.png" class="img-fluid" alt="Intersect Consortium Brand Logo" title="Intersect Consortium" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="crs_partn">
                    <div class="p-3">
                        <img src="~/assets/img/SwipeNGLogo.png" class="img-fluid" alt="Swipe NG Brand Logo" title="Swipe NG" />
                    </div>
                </div>
            </div>
