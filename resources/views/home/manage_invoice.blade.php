                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <div class="dashboard_stats_wrap">
                                    <div class="rounded-circle p-4 p-sm-4 d-inline-flex align-items-center justify-content-center theme-bg mb-2"><div class="position-absolute text-white h5 mb-0"><i class="fas fa-file"></i></div></div>
                                    <div class="dashboard_stats_wrap_content"><h5>₦ @ViewBag.totalUnpaidInvoices</h5> <span>Unpaid Invoices</span></div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <div class="dashboard_stats_wrap">
                                    ...
                                    <div class="dashboard_stats_wrap_content"><h5>@ViewBag.totalOrders</h5> <span>Total Orders</span></div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <div class="dashboard_stats_wrap">
                                    ...
                                    <div class="dashboard_stats_wrap_content"><h5>₦ @ViewBag.totalOrdersIn7Days</h5> <span>Orders in 7days</span></div>
                                </div>
                            </div>

                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <div class="dashboard_stats_wrap">
                                    <div class="rounded-circle p-4 p-sm-4 d-inline-flex align-items-center justify-content-center bg-purple mb-2"><div class="position-absolute text-white h5 mb-0"><i class="fas fa-chart-line"></i></div></div>
                                    <div class="dashboard_stats_wrap_content"><h5>@ViewBag.totalExpenseIn7Days</h5> <span>Expense in 7days</span></div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="dashboard_wrap">
                                    ...
                                    <div class="row justify-content-between">
                                        <div class="col-xl-12 col-lg-12 col-md-12">
                                            @using (Html.BeginForm("FilterInvoices", "Home", FormMethod.Post))
                                            {
                                                                    ...
                                                                    foreach (var Data in Model.Invoices)
                                                                    {
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td><a href="https://foodstuff.store/apps/invoicepreview?InvoiceID=@Data.InvoiceID" target="_blank"><span class="smalls">@Data.InvoiceID</span></a></td>
