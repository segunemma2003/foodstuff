                        ...
                        <div class="abt_apps">
                            <ul>
                                <li>
                                    ...
                                    <div class="abt_right"><span>@ViewBag.appVersion</span></div>
                                </li>
                                <li>
                                    <div class="abt_left">Last Update</div>
                                    <div class="abt_right"><span>@ViewBag.lastAppUpdate</span></div>
                                </li>
                                <li>
                                    <div class="abt_left">Change Log (last 10 updates)</div>
                                    <div class="abt_right">
                                        <span>
                                            <a href="#" data-toggle="modal" data-target="#changeLogModal" class="text-danger">View</a>
                                        </span>
                                    </div>
                                </li>
                                <li>
                                    <div class="abt_left">Curl Enable</div>
                                    <div class="abt_right"><span class="elso bg-light-success text-success">Enable</span></div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="abt_right"><span class="elso bg-light-success text-success">True</span></div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="abt_right"><span><a href="mailto:mailus.jedilabs@gmail.com" class="text-danger">Click To Mail</a></span></div>
                                </li>
                                <li>
                                    <div class="abt_left">Support Service</div>
                                    <div class="abt_right"><span class="elso bg-light-success text-success">Active</span></div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Lastest Updates</h5>
                                                ...
                                                <ul>
                                                    ...
                                                    @{
                                                        ...
                                                        foreach (var Data in Model.ChangeLog)
                                                        {
                                                            count++;
                                                            <li>
                                                                <div class="abt_left"><h5>@count. @Data.LogName<br /></h5>⇒ @Data.AboutLog <br />⇒ @Data.LastEditedDate</div>
                                                            </li>
                                                        }
                                                    }
