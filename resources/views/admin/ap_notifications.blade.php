                                ...
                                <div class="smalls">
                                    <select id="prc" name="Rows" class="form-control">
                                        @{
                                            ...
                                            {
                                                if (ViewBag.selectedNotificationListLimit == Data.Value)
                                                {
                                    ...
                                    <select id="prc" name="Filter" class="form-control">
                                        @{
                                            var list2 = new List<KeyValuePair<string, string>>() {
                                                ...
                                                new KeyValuePair<string, string>("Pending Action", "false"),
                                                new KeyValuePair<string, string>("Done With", "true"),
                                            };

                                            foreach (var Data in list2)
                                            {
                                                if (ViewBag.selectedNotificationType == Data.Value)
                                                {
                                                    <option value="@Data.Value" selected>@Data.Key</option>
                                                }
                                                else
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 mb-2">
                        <div class="table-responsive">
                            ...
                            @{
                                ...
                                {
                                    int i = 0;
                                    foreach (var Data in Model.Notifications)
                                    {
                                        i++;
                                    }
                                                ...
                                                @{
                                                    ...
                                                    foreach (var Data in Model.Notifications)
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><h6>@Data.Message</h6><p>Date: <span>@Data.ServerDateTime</span></p></td>
                                                            <td><div class="dhs_tags">@Data.Done</div></td>
                                                            <td><div class="smalls">@Data.Redirect</div></td>
                                                            <td><span class="smalls">@Data.Type</span></td>
                                                            <td>
                                                                <div class="dropdown show">
                                                                    ...
                                                                    <div class="drp-select dropdown-menu">
                                                                        @using (Html.BeginForm("SignNotifications", "Admin", FormMethod.Post))
                                                                        {
                                                                            <input type="text" name="IDLabel" value="@Data.ID" hidden />
                                                                            <input type="text" name="Signature" value="@Data.Done" hidden />
