...
<div class="col-lg-9 col-md-9 col-sm-12">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                ...
                <div class="dashboard_stats_wrap_content"><h5>₦ @ValueHelper.BalanceFormatter("", ViewBag.totalUserExpenditure.ToString())</h5> <span>Total Expenditure</span></div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                ...
                <div class="dashboard_stats_wrap_content"><h5>@ViewBag.totalUserNumberOUnPaidInvoices</h5> <span>UnPaid Invoices</span></div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                ...
                <div class="dashboard_stats_wrap_content"><h5>@ViewBag.totalUserNumberOfPaidInvoices</h5> <span>Paid Invoices</span></div>
            </div>
        </div>

        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <div class="rounded-circle p-4 p-sm-4 d-inline-flex align-items-center justify-content-center bg-purple mb-2"><div class="position-absolute text-white h5 mb-0"><i class="fas fa-box"></i></div></div>
                <div class="dashboard_stats_wrap_content"><h5>@ViewBag.totalUserCompanyOrdersIn7Days</h5> <span>Orders in 7days</span></div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <div class="rounded-circle p-4 p-sm-4 d-inline-flex align-items-center justify-content-center theme-bg mb-2"><div class="position-absolute text-white h5 mb-0"><i class="fas fa-chart-line"></i></div></div>
                <div class="dashboard_stats_wrap_content"><h5>₦ @ValueHelper.BalanceFormatter("", ViewBag.totalUserExpenditureIn7days.ToString())</h5> <span>Expenditure in 7days</span></div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <div class="rounded-circle p-4 p-sm-4 d-inline-flex align-items-center justify-content-center bg-primary mb-2"><div class="position-absolute text-white h5 mb-0"><i class="fas fa-hourglass"></i></div></div>
                <div class="dashboard_stats_wrap_content"><h5>₦ @ValueHelper.BalanceFormatter("", ViewBag.totalUserDebt.ToString())</h5> <span>Users Owe</span></div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <div class="rounded-circle p-4 p-sm-4 d-inline-flex align-items-center justify-content-center bg-warning mb-2"><div class="position-absolute text-white h5 mb-0"><i class="fas fa-check"></i></div></div>
                <div class="dashboard_stats_wrap_content"><h5>₦ @ValueHelper.BalanceFormatter("", ViewBag.totalUserSumOfPaidInvoices.ToString())</h5> <span>Paid Invoices</span></div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <div class="rounded-circle p-4 p-sm-4 d-inline-flex align-items-center justify-content-center bg-purple mb-2"><div class="position-absolute text-white h5 mb-0"><i class="fas fa-box"></i></div></div>
                <div class="dashboard_stats_wrap_content"><h5>@ViewBag.totalUserOrder</h5> <span>Total Orders</span></div>
            </div>
        </div>
                                        ...
                                        <table class="table dash_list">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">
                                                        <a class="btn btn-action" asp-area="" asp-controller="Home" asp-action="APManageInvoice" target="_blank" title="Create Invoice" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <div class="col-lg-6 col-md-10">
                                                <div class="text-center">
                                                    ...
                                                    <h5 style="color:#818181;">
                                                        It appears this user is yet to make a purchase. If not adjust your search for a different result.
                                                    </h5>
