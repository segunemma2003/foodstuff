        ...
        <div class="row align-items-center justify-content-between mb-5">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="lmp_caption">
                    ...
                    <div class="text-left mt-4"><a asp-area="" asp-controller="Home" asp-action="Store" class="btn btn-md text-light theme-bg">Store Front</a></div>
                </div>
            </div>
                        ...
                        <li class="d-flex align-items-start my-3 my-md-4">
                            ...
                            <div class="ml-3 ml-md-4">
                                ...
                                <p>
                                    ...
                                    Goto our <a asp-area="" asp-controller="Home" asp-action="RequestInvoice" style="color:#E10C2C;">Create Shopping List</a> page. You can also download our mobile application
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 col-md-8 mt-2">
                <div class="text-center">
                    <a asp-area="" asp-controller="Home" asp-action="Blog" class="btn btn-md theme-bg-light theme-cl">Explore More</a>
                </div>
            </div>
        </div>
