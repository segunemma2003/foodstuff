            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="dashboard_wrap">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            {{-- <form method="post" action="{{ route('home.AddFoodStuffToShoppingList') }}"> --}}
                                            ...
                                            <div class="smalls">
                                                <select id="cates" name="FoodItem" class="form-control">
                                                    @foreach ($FoodStuffs as $Data)
                                                        @if ($selectedRIProduct === $Data->Name)
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 mb-2">
                            <div class="table-responsive">
                                ...
                                <table class="table dash_list">
                                    ...
                                    @foreach ($ShoppingList as $index => $Data)
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dropdown show">
                                                    ...
                                                    <div class="drp-select dropdown-menu">
                                                        <form method="post" action="{{ route('home.AddQuantityShoppingListItem') }}">
                                                            @csrf
                                                            <input type="hidden" name="IDLabel" value="{{ $Data->ID }}">
                                                            <button class="dropdown-item" type="submit">Add Quantity</button>
                                                        </form>
                                                        <form method="post" action="{{ route('home.RemoveQuantityShoppingListItem') }}">
                                                            @csrf
                                                            <input type="hidden" name="IDLabel" value="{{ $Data->ID }}">
                                                            <button class="dropdown-item" type="submit">Remove Quantity</button>
                                                        </form>
                                                        <form method="post" action="{{ route('home.DeleteShoppingListItem') }}">
                                                            @csrf
                                                            <input type="hidden" name="IDLabel" value="{{ $Data->ID }}">
                                                            <button class="dropdown-item" type="submit">Delete Item</button>
                                                        </form>
                                                        <form method="post" action="{{ route('home.ResetQuantityShoppingListItem') }}">
                                                            @csrf
                                                            <input type="hidden" name="IDLabel" value="{{ $Data->ID }}">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-6 col-md-10">
                                        <div class="text-center">
                                            <img src="{{ asset('assets/img/EmptyShoppingList.png') }}" style="width:50%;" class="img-fluid" alt="" />
                                            <br /><br />
                                            <h4>Your shopping list is empty, add some food items.</h4>
                                        </div>
                                    </div>
                                </div>
                                @endif
                    ...
                    {{-- <form method="post" action="{{ route('home.WhatappOrderShoppingList') }}"> --}}
                    <form method="post" action="">
                        @csrf
                        <div class="row align-items-end mb-5">
                            <div class="col-xl-5 col-lg-4 col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="smalls">
                                        <input type="text" class="form-control" name="InvoiceID" value="" hidden required>
                                        <input type="text" class="form-control" name="UUID" value="" hidden required>
                                        <input type="text" class="form-control" name="FullName" value="" maxlength="50" placeholder="Your full name" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-5 col-lg-8 col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="smalls">
                                        <input type="text" class="form-control" name="Address" value="" maxlength="500" placeholder="House NO, Street, City, State, Country" required>
                                    </div>
                                </div>
                            </div>
