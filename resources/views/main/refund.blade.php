        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="breadcrumbs-wrap">
                    <h1 class="breadcrumb-title">Return & Refund Policy</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <div class="section-title">
                                            <h2 class="ec-title">Return & Refund Policy</h2>
                                            <p class="sub-title mb-3">Updated at 2022-23-05</p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="ec-common-wrapper">
                                            <div class="ec-faq-wrapper">
                                                <div class="ec-faq-container">
                                                    ...
                                                    <p>Thank you for shopping at FoodStuff Store website and FoodStuff Store app.</p>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named FoodStuff Store</p>
                                                        </li>
                                                        <li>
                                                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to FoodStuff Store, 215 Konoko Crescent, Wuse II, Abuja, Nigeria.</p>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <p><strong>Website</strong> refers to FoodStuff Store, accessible from <a href="https://foodstuff.store" rel="external nofollow noopener" target="_blank">https://foodstuff.store</a></p>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <p>&nbsp; ➼ By email: info@foodstuff.store</p>
                                                        </li>
                                                        <li>
                                                            <p>&nbsp; ➼ By phone number: +234 818 272 3701</p>
                                                        </li>
                                                    </ul>
