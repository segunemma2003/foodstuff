...
<section class="pt-0">
    <div class="container">
        ...
        <div class="row justify-content-center">
            {{-- @if (!empty(View::get('credit')) && is_numeric(View::get('credit'))) --}}
            {{-- @php
            $formattedBalance = ValueHelper::BalanceFormatter("₦", doubleval(View::get('credit')));
            @endphp --}}
                ...
                <div class="crp_box fl_color ovr_top">
                    <div class="row align-items-center">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mt-3">
                            <form id="paymentForm">
                                <div>
                                    <input type="number" placeholder="Enter an amount" class="form-control" id="amount"
                                        value="" required />
                                </div>
                                ...
                                <div class="dro_140">
                                    <div class="dro_141">
                                        <img src="~/assets/img/PaystackLogo2.png" width="30" height="30"
                                            alt="Paystack brand logo">
                                    </div>
                                    <div class="dro_142">
                                        <h6>TopUp with Paystack</h6>
                                    </div>
                                    <button type="submit" onclick="payWithPaystack()" id="paystack-button">Top
                                        Up</button>
                                </div>
                            </form>
                        </div>

                        {{-- @if (View::get('useFlutterwavePG') == "true") --}}
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mt-3">
                            <form method="POST" action="https://checkout.flutterwave.com/v3/hosted/pay">
                                <div>
                                    <input type="number" placeholder="Enter an amount" class="form-control"
                                        name="amount" value="" required />
                                </div>
                                <input type="hidden" name="public_key"
                                    value="FLWPUBK_TEST-bc53d85035a42cf5e6a708a256678ccf-X" />
                                ...
                                <div class="dro_140">
                                    <div class="dro_141">
                                        <img src="~/assets/img/FlutterwaveLogo2.png" width="35" height="30"
                                            alt="Flutterwave brand logo">
                                    </div>
                                    <div class="dro_142">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-6 col-md-10">
                                        <div class="text-center">
                                            <img src="~/assets/img/EmptyActivity.png" style="width:50%;"
                                                class="img-fluid" alt="" /><br /><br />
                                            <h4>
                                                Nothing to see here, view other activities.
                                            </h4><br />
                                            <a asp-area="" asp-controller="Home" asp-action="Activities"
                                                class="btn btn-md full-width theme-bg text-white">View Other
                                                Activities</a>
                                        </div>
                                    </div>
                                </div>
