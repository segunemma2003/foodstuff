        ...
        <div class="row align-items-center justify-content-between rounded m-0">
            <div class="col-lg-7 col-md-7">
                <div class="aps_crs_caption">
                    ...
                    <p>
                        Have food products delivered to your door from thousands of local and national farmers and
                        suppliers. Find
                    ...
                    <div class="aps_buttons mt-4">
                        <a href="#" class="btn_aps mr-4">
                            <div class="aps_wrapb theme-bg">
                                <div class="aps_ico"><img src="~/assets/img/apple.png" class="img-fluid" alt="" /></div>
                                <div class="aps_capt"><span>Download On The</span>
                                    <h4>App Store</h4>
                                </div>
                            </div>
                        </a>
                        <a href="https://play.google.com/store/apps/details?id=com.foodstuff.store" target="_blank"
                            class="btn_aps">
                            <div class="aps_wrapb">
                                <div class="aps_ico"><img src="~/assets/img/google-play.png" class="img-fluid" alt="" />
                                </div>
                                <div class="aps_capt"><span>Get It On</span>
                                    <h4>Google Play</h4>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="bb-video-box">
                        <div class="bb-video-box-inner">
                            <div class="bb-video-box-innerup">
                                <a href="https://www.youtube.com/watch?v=@ViewBag.aboutOurMobileApp"
                                    onclick="playYoutubeVideo()" data-toggle="modal" data-target="#video"
        ...
        <div class="modal-content overli" id="loginmodal">
            ...
            <div class="modal-body">
                <div class="login-form">
                    <form>
                        <iframe style="display:none; width:100%; height:300px" id="yt"
                            src="https://www.youtube.com/embed/@ViewBag.aboutOurMobileApp" frameborder="0"
